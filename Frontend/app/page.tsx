  ...
  return (
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <section className="flex flex-col flex-1 justify-center items-center gap-8 px-6 py-24 md:py-36 text-center">
        ...
        <h1 className="max-w-3xl font-bold text-foreground text-4xl md:text-6xl leading-tight tracking-tight">
          Study smarter.{" "}
      ...
      {/* ── Features ── */}
      <section className="bg-muted px-6 md:px-10 py-20 border-border border-t">
        <div className="mx-auto max-w-5xl">
          <h2 className="mb-12 font-semibold text-foreground text-2xl md:text-3xl text-center tracking-tight">
          ...
          <div className="gap-8 grid sm:grid-cols-2 lg:grid-cols-4">
            {features.map(({ icon: Icon, title, description }) => (
              <div
                key={title}
                className="flex flex-col gap-3 bg-card shadow-sm p-6 ring-border rounded-2xl ring-1"
              >
      ...
      <section className="flex flex-col items-center gap-6 px-6 md:px-10 py-20 text-center">
        <h2 className="font-semibold text-foreground text-2xl md:text-3xl tracking-tight">
      ...
      {/* ── Footer ── */}
      <footer className="px-6 py-6 border-border border-t text-muted-foreground text-sm text-center">
